...
function initMiddleware (middlewares, middlewaresArgsNum, req, res, index, routeIndex, routers = {}, defaultRoute, errorHandler, error) {
...
function next (middlewares, middlewaresArgsNum, req, res, index, routeIndex, routers = {}, defaultRoute, errorHandler, error) {
  ...
  function paramOrNot () {
    if (routeIndex < req.routesToProcess.length) {
      ...
      if ((curRoute.handlers.length) === req.currentRouteMiddlewareNum) {
        routeIndex++
...
module.exports = {initMiddleware, next}
