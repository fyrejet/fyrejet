...
res.send = function send (body) {
  ...
  if (arguments.length === 2) {
    ...
    sendDeprecateTwoArgs(arguments, this)
  }
  ...
  if (chunk !== undefined) {
    ...
    var generateETag = etagFn.length && !req.rData_internal.noEtag && !this.get('ETag')
  ...
  if (req.method !== 'HEAD') { // HEAD is likely to be much more rare
    // respond
