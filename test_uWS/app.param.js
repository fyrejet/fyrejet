...
describe('app', function () {
  ...
  describe('.param(name, fn)', function () {
    ...
    //  });
    //
    //  app.get('/:user/bob', function one(req, res, next) {
    //    count++;
    //    next();
    //  });
    //  app.get('/foo/:user', function two(req, res, next) {
    //    count++;
    //    next();
    //  });
    //  app.use(function(req, res) {
    ...
    // We fail this test, but deem it as not important. If you have a strong reason to disagree, let us know, preferably with a Pull Request offering your fix
  })
})
